...
plot(muestra, pesos, cex=0.9, col="green")  
lines(tapply(pesos,muestra,mean), col="blue", lwd=2) # Agregar una línea sobre la media de fenitoina
...
####################################################
# Procedimiento para fenit1 que no sigue la 
# distribución normal 
####################################################

# Limpiar todos los objetos, gráficos y consola
# Calcular el resumen de los 5 números + la media
...
# Gráficos de control
obj <- qcc(fenit1a, type="xbar") # Gráfico de media
obj1 <- qcc(fenit1a, type="R") # Gráfico de rangos
obj2 <- qcc(fenit1a, type="S") # Gráfico de desviación estándar 
